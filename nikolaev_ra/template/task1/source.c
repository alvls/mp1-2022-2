...
void main()
{
	...
	const float fibreboard_thickness = 0.5;
	const float chipboard_thickness = 1.5;
	const float wood_door_thickness = 1;
	...
	float h, w, d;
	printf("Enter the values h (180-220 cm), w (80-120 cm), d (50-90 cm): ");
	scanf_s("%f %f %f", &h, &w, &d);
