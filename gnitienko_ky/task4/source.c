...
void main()
{
	...
	printf("СТОИМОСТЬ               | ШТРИХ-КОД |    ЦЕНА\n");
	for (int i = 0; i < SIZE; i++) {
	...
	printf("\n\n\nНАИМЕНОВАНИЕ ТОВАРА        |  КОЛИЧЕСТВО  |  СТОИМОСТЬ  |      СКИДКА      |  ИТОГО ЗА ТОВАР\n");
