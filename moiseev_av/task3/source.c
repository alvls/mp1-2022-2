...
void main()
{
	...
	int n, detecter, user_num, user_num_clone, user_numberi = 11, bol = 0, cow = 0;
	const int COUNT = 9, COUNT_word = 8, COUNT_num = 8;

	char ch, array[] = {'W', 'e', 'l', 'c', 'o', 'm', 'e', '!'}; //Создаём массивы//
	int num[4], user_numbers[] = {11, 12, 13, 14};
	...
	else  //Создание случайного числа с не повторяющимися числами, с последующим добавлением в массив//
	{
		number0 = 1 + rand() % 9;
		if (n == 2)
		{
